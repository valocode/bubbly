...
func (t *task) Apply(ctx *core.ResourceContext) error {
	fmt.Printf("body: %v\ttask: %v\n", t.taskBlockSpec.Body, t)
	if err := ctx.DecodeBody(nil, t.taskBlockSpec.Body, t); err != nil {
