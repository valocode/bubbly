...
import (
	...
	testDataJSON "github.com/verifa/bubbly/api/v1/testdata/extract/json"
	testDataXML "github.com/verifa/bubbly/api/v1/testdata/extract/xml"
...
func TestExtractJSON(t *testing.T) {
	...
	source := jsonSource{
		File:   filepath.FromSlash(`testdata/extract/json/sonarqube-example.json`),
		Format: ctyType,
	}
	...
	assert.False(t, val.IsNull(), "the extract returned null type value")
	assert.False(t, val.Equals(expected).False(), "the extract returned unexpected value")
}
