...
func LabelsIsNil() predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
...
func LabelsNotNil() predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
...
func HasOwnerWith(preds ...predicate.Organization) predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasHead() predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasHeadWith(preds ...predicate.Release) predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
