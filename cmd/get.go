...
func NewCmdGet(bCtx *env.BubblyContext) (*cobra.Command, *GetOptions) {
	...
	f.BoolVarP(&o.events, "events", "e", false, "specify whether to display resource events")
...
func (o *GetOptions) Resolve(cmd *cobra.Command) error {
...
// Print formats and prints the GetOptions.Result from o.Run()
func (o *GetOptions) Print(cmd *cobra.Command) {
